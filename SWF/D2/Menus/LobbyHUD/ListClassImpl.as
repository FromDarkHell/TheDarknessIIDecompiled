class ListClassImpl
{
   ...
   function SetAlignment(a)
   {
      ...
      while(_loc2_ < this.mLabels.length)
      {
         ...
         {
            _loc3_._x = _loc4_._x = this.mLabels[_loc2_].TxtHolder._width / 2 - _loc3_._width / 2;
         }
   ...
   {
      var _loc1_ = thisClip.TxtHolder.Txt;
      var _loc3_ = thisClip.Btn;
      if(thisClip.Txt)
      {
         _loc1_ = thisClip.Txt;
      }
      _loc1_.text = entryContent;
      var _loc4_ = _loc1_.textWidth;
