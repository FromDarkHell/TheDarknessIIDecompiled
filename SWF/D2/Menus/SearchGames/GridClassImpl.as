class GridClassImpl
{
   ...
   function SetItemVisible(gx, gy, v)
   {
      ...
      {
         if(!this.IsItemInClipArea(gx,gy))
         {
            v = false;
         }
         _loc2_._visible = v;
   ...
   function UpdateItemPos(gx, gy)
   {
      ...
      var _loc5_ = this.thisMC._y;
      var _loc7_ = this.thisMC._x;
      var _loc4_ = gx - this.mItemOffsetX;
      while(_loc4_ < this.mDimensionX)
      {
         var _loc6_ = 0;
         if(this.mItemWidth == 0)
         {
            ...
            while(_loc3_ < this.mDimensionY)
            {
               var _loc2_ = this.GetMovieClip(_loc4_,_loc3_);
         ...
         {
            _loc6_ = this.mItemWidth;
         }
         _loc5_ = this.thisMC._y;
         _loc3_ = gy - this.mItemOffsetY;
         while(_loc3_ < this.mDimensionY)
         {
            _loc2_ = this.GetMovieClip(_loc4_,_loc3_);
            _loc2_._x = _loc7_;
            _loc2_._y = _loc5_;
            if(this.IsItemInClipArea(_loc4_,_loc3_))
            {
               if(_loc2_ == undefined || _loc2_ == null || this.mItemHeight != 0)
               {
                  _loc5_ = _loc5_ + this.mItemHeight;
               }
               else
               {
                  _loc5_ = _loc5_ + _loc2_._height;
               }
               _loc5_ = _loc5_ + this.mItemSpacingY;
            }
            _loc3_ = _loc3_ + 1;
         }
